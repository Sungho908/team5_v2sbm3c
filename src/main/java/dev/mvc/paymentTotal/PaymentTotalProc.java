...
//      str.append("<div class=\"contents\" id=\"btnDiv\">");
      ...
      str.append("  <button type=\"button\" class=\"collapsible\" onclick=\"collapseChild(this);\" style=\"padding: 5px;\">");
      ...
      for(PaymentDetailsOptionVO pdo : payment.getPayment_details_option()) {
        str.append("        <div>");
        str.append("          <span class=\"color-white\" style=\"width: 120px; float: left;\">주문상세번호: " + pdo.getPayment_details_no() + "</span>");
        str.append("          <span class=\"color-white\">상 품 명:" + pdo.getTitle() +" </span>");
        str.append("        </div>");
      }
      str.append("        <span class=\"color-white block\">주문일자: " + simpleDateFormat.format(payment.getRdate()) + "</span>");
      str.append("      </div>");
      ...
      str.append("        <span class=\"color-white block\">C S 상태: " + (payment.getCs_status() != null ? payment.getCs_status() : "NULL")  + "</span>");
      str.append("      </div>");
      str.append("    </div>");
      str.append("  </button>");
      ...
      str.append("      <div style=\"float:right;\">");
      str.append("        <button style=\"position: relative; bottom: 0px; right: 0px; height: 56px; width: 8rem; border: 1px solid #bbb; background-color: #e63740; color:#fff\" onclick=\"submit(this)\" type=\"button\">적용하기</button>");
      str.append("      </div>");
      str.append("    </div>");
      ...
      for(PaymentDetailsOptionVO pdo : payment.getPayment_details_option()) {
        ...
        str.append("                <span th:text=\"|${pdo.sizes} / ${pdo.color}|\">" + pdo.getSizes() + " / "  + pdo.getColor() + "</span>");
        str.append("              </div>");
        str.append("            </td>");
        str.append("          </tr>");
        str.append("        </tbody>");
